...
public class TestDb extends AndroidTestCase {
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: empty weather cursor was returned.", cursor.moveToFirst());

        TestUtilities.validateCurrentRecord("Error: Weather query validation failed",
                cursor, TestUtilities.createWeatherValues(weatherRowId));
    ...
    public long insertLocation(SQLiteDatabase db) {
        ...
        return db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, cv);
    }
}
