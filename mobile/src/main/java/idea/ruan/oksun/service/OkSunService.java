package idea.ruan.oksun.service;
...
import idea.ruan.oksun.R;
import idea.ruan.oksun.data.WeatherContract;

public class OkSunService extends IntentService {

    private final String LOG_TAG = OkSunService.class.getSimpleName();
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            PreferenceManager.getDefaultSharedPreferences(this).edit()
                    .putString(this.getString(R.string.current_location_coords),
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String locationQuery = intent.getStringExtra(getString(R.string.current_location_key));
